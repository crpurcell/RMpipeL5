...
#                                                                             #
# TODO:                                                                       #
#           * Implement an LPF alternative, which should be the fallback mode #
#             if the fit fails.                                               #
#           * Check that blanked (NaN) planes are dealt with correctly.       #
...
from Imports.module_spec_extract import *
